...
pub trait MX106<const PROTOCOL_VERSION: u8>: Protocol<PROTOCOL_VERSION> {
    /// Model Number (initial: 320)
    fn get_mx106_model_number(&mut self, id: u8) -> Result<u16, Self::Error> {
    ...
    fn get_mx106_firmware_version(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_id(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_mx106_id(&mut self, id: u8, params: u8) -> Result<Option<Response<1>>, Self::Error> {
    ...
    fn get_mx106_baud_rate(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_return_delay_time(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_cw_angle_limit(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_ccw_angle_limit(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    /// Dual Mode Setting (initial: 0)
    fn get_mx106_drive_mode(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_temperature_limit(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_min_voltage_limit(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_max_voltage_limit(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_max_torque(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_status_return_level(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_alarm_led(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_shutdown(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_multi_turn_offset(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_mx106_multi_turn_offset(
        &mut self,
        id: u8,
        params: u16,
    ) -> Result<Option<Response<2>>, Self::Error> {
    ...
    fn get_mx106_resolution_divider(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_mx106_resolution_divider(
        &mut self,
        id: u8,
        params: u8,
    ) -> Result<Option<Response<1>>, Self::Error> {
    ...
    fn get_mx106_torque_enable(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_led(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_mx106_led(&mut self, id: u8, params: u8) -> Result<Option<Response<1>>, Self::Error> {
        let params = params.to_le_bytes();
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_d_gain(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_mx106_d_gain(&mut self, id: u8, params: u8) -> Result<Option<Response<1>>, Self::Error> {
        let params = params.to_le_bytes();
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_i_gain(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_mx106_i_gain(&mut self, id: u8, params: u8) -> Result<Option<Response<1>>, Self::Error> {
        let params = params.to_le_bytes();
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_p_gain(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_mx106_p_gain(&mut self, id: u8, params: u8) -> Result<Option<Response<1>>, Self::Error> {
        let params = params.to_le_bytes();
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_goal_position(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_moving_speed(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_torque_limit(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_present_position(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_present_speed(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_present_load(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_present_voltage(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_present_temperature(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_registered(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_moving(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_lock(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_mx106_lock(&mut self, id: u8, params: u8) -> Result<Option<Response<1>>, Self::Error> {
        let params = params.to_le_bytes();
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_punch(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_mx106_punch(&mut self, id: u8, params: u16) -> Result<Option<Response<2>>, Self::Error> {
        let params = params.to_le_bytes();
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_realtime_tick(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_mx106_current(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
            self.send(id, Instruction::Read, &[68, 2]);
        } else {
            self.send(id, Instruction::Read, &[68, 0, 2, 0]);
        }
        if self.n_recv() == 2 {
            self.recv::<4>()?;
        }
    ...
    fn set_mx106_current(
        ...
        if PROTOCOL_VERSION == 1 {
            ...
            self.send(id, Instruction::Write, &[68, 0, params[0], params[1]]);
        }
        if self.n_recv() == 2 {
            self.recv::<4>()?;
        }
    ...
    fn get_mx106_torque_ctrl_mode_enable(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_mx106_torque_ctrl_mode_enable(
        &mut self,
        id: u8,
        params: u8,
    ) -> Result<Option<Response<1>>, Self::Error> {
        let params = params.to_le_bytes();
        if PROTOCOL_VERSION == 1 {
            self.send(id, Instruction::Write, &[70, params[0]]);
        } else {
            self.send(id, Instruction::Write, &[70, 0, params[0]]);
        }
        if self.n_recv() == 2 {
            self.recv::<3>()?;
        }
    ...
    fn get_mx106_goal_torque(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
            self.send(id, Instruction::Read, &[71, 2]);
        } else {
            self.send(id, Instruction::Read, &[71, 0, 2, 0]);
        }
        if self.n_recv() == 2 {
            self.recv::<4>()?;
        }
    ...
    fn set_mx106_goal_torque(
        ...
        let params = params.to_le_bytes();
        if PROTOCOL_VERSION == 1 {
            self.send(id, Instruction::Write, &[71, params[0], params[1]]);
        } else {
            self.send(id, Instruction::Write, &[71, 0, params[0], params[1]]);
        }
        if self.n_recv() == 2 {
            self.recv::<4>()?;
        }
    ...
    fn get_mx106_goal_acceleration(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_mx106_goal_acceleration(
        &mut self,
        id: u8,
        params: u8,
    ) -> Result<Option<Response<1>>, Self::Error> {
...
impl<Serial, Direction> MX106<1> for Controller<Serial, Direction, 1>
where
...
impl<Serial, Direction> MX106<2> for Controller<Serial, Direction, 2>
where
    Serial: serial::Write<u8> + serial::Read<u8>,
    Direction: OutputPin,
{
