...
pub trait RX10<const PROTOCOL_VERSION: u8>: Protocol<PROTOCOL_VERSION> {
    /// Model Number (initial: 10)
    fn get_rx10_model_number(&mut self, id: u8) -> Result<u16, Self::Error> {
    ...
    fn get_rx10_firmware_version(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_id(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_rx10_id(&mut self, id: u8, params: u8) -> Result<Option<Response<1>>, Self::Error> {
    ...
    fn get_rx10_baud_rate(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_return_delay_time(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_cw_angle_limit(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_ccw_angle_limit(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_temperature_limit(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_min_voltage_limit(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_max_voltage_limit(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_max_torque(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_status_return_level(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_alarm_led(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_shutdown(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_torque_enable(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_led(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_rx10_led(&mut self, id: u8, params: u8) -> Result<Option<Response<1>>, Self::Error> {
        let params = params.to_le_bytes();
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_cw_compliance_margin(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_ccw_compliance_margin(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_cw_compliance_slope(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_ccw_compliance_slope(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_goal_position(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_moving_speed(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_torque_limit(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_present_position(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_present_speed(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_present_load(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_present_voltage(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_present_temperature(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_registered(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_moving(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_lock(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_rx10_lock(&mut self, id: u8, params: u8) -> Result<Option<Response<1>>, Self::Error> {
        let params = params.to_le_bytes();
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_rx10_punch(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_rx10_punch(&mut self, id: u8, params: u16) -> Result<Option<Response<2>>, Self::Error> {
        let params = params.to_le_bytes();
        if PROTOCOL_VERSION == 1 {
...
impl<Serial, Direction> RX10<1> for Controller<Serial, Direction, 1>
where
...
impl<Serial, Direction> RX10<2> for Controller<Serial, Direction, 2>
where
    Serial: serial::Write<u8> + serial::Read<u8>,
    Direction: OutputPin,
{
