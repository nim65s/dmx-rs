...
pub trait EX106PLUS<const PROTOCOL_VERSION: u8>: Protocol<PROTOCOL_VERSION> {
    /// Model Number (initial: 107)
    fn get_ex106plus_model_number(&mut self, id: u8) -> Result<u16, Self::Error> {
    ...
    fn get_ex106plus_firmware_version(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_ex106plus_id(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_ex106plus_id(&mut self, id: u8, params: u8) -> Result<Option<Response<1>>, Self::Error> {
    ...
    fn get_ex106plus_baud_rate(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_ex106plus_return_delay_time(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_ex106plus_return_delay_time(
        &mut self,
        id: u8,
        params: u8,
    ) -> Result<Option<Response<1>>, Self::Error> {
    ...
    fn get_ex106plus_cw_angle_limit(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_ex106plus_cw_angle_limit(
        &mut self,
        id: u8,
        params: u16,
    ...
    fn get_ex106plus_ccw_angle_limit(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_ex106plus_ccw_angle_limit(
        &mut self,
        id: u8,
        params: u16,
    ) -> Result<Option<Response<2>>, Self::Error> {
    ...
    fn get_ex106plus_drive_mode(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_ex106plus_temperature_limit(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_ex106plus_temperature_limit(
        &mut self,
        id: u8,
        params: u8,
    ) -> Result<Option<Response<1>>, Self::Error> {
    ...
    fn get_ex106plus_min_voltage_limit(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_ex106plus_min_voltage_limit(
        &mut self,
        id: u8,
        params: u8,
    ) -> Result<Option<Response<1>>, Self::Error> {
    ...
    fn get_ex106plus_max_voltage_limit(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_ex106plus_max_voltage_limit(
        &mut self,
        id: u8,
        params: u8,
    ) -> Result<Option<Response<1>>, Self::Error> {
    ...
    fn get_ex106plus_max_torque(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_ex106plus_status_return_level(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_ex106plus_status_return_level(
        &mut self,
        id: u8,
        params: u8,
    ) -> Result<Option<Response<1>>, Self::Error> {
    ...
    fn get_ex106plus_alarm_led(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_ex106plus_shutdown(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_ex106plus_torque_enable(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_ex106plus_torque_enable(
        &mut self,
        id: u8,
        params: u8,
    ) -> Result<Option<Response<1>>, Self::Error> {
    ...
    fn get_ex106plus_led(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_ex106plus_cw_compliance_margin(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_ex106plus_cw_compliance_margin(
        &mut self,
        id: u8,
        params: u8,
    ) -> Result<Option<Response<1>>, Self::Error> {
    ...
    fn get_ex106plus_ccw_compliance_margin(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_ex106plus_ccw_compliance_margin(
        &mut self,
        id: u8,
        params: u8,
    ) -> Result<Option<Response<1>>, Self::Error> {
    ...
    fn get_ex106plus_cw_compliance_slope(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_ex106plus_cw_compliance_slope(
        &mut self,
        id: u8,
        params: u8,
    ) -> Result<Option<Response<1>>, Self::Error> {
    ...
    fn get_ex106plus_ccw_compliance_slope(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_ex106plus_ccw_compliance_slope(
        &mut self,
        id: u8,
        params: u8,
    ) -> Result<Option<Response<1>>, Self::Error> {
    ...
    fn get_ex106plus_goal_position(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn set_ex106plus_goal_position(
        &mut self,
        id: u8,
        params: u16,
    ) -> Result<Option<Response<2>>, Self::Error> {
    ...
    fn get_ex106plus_moving_speed(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_ex106plus_torque_limit(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_ex106plus_present_position(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_ex106plus_present_speed(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_ex106plus_present_load(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_ex106plus_present_voltage(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_ex106plus_present_temperature(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_ex106plus_registered(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_ex106plus_moving(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_ex106plus_lock(&mut self, id: u8) -> Result<u8, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    fn get_ex106plus_punch(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
    ...
    /// Consuming Current (initial: -)
    fn get_ex106plus_sensed_current(&mut self, id: u8) -> Result<u16, Self::Error> {
        if PROTOCOL_VERSION == 1 {
            self.send(id, Instruction::Read, &[56, 2]);
        } else {
            self.send(id, Instruction::Read, &[56, 0, 2, 0]);
        }
        if self.n_recv() == 2 {
            self.recv::<4>()?;
        }
...
impl<Serial, Direction> EX106PLUS<1> for Controller<Serial, Direction, 1>
where
...
impl<Serial, Direction> EX106PLUS<2> for Controller<Serial, Direction, 2>
where
    Serial: serial::Write<u8> + serial::Read<u8>,
    Direction: OutputPin,
{
