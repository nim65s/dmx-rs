...
pub trait MX106<Error>: Protocol<Error> {
    ...
    fn set_mx106_id(&mut self, id: u8, params: u8) -> Result<(), Error> {
    ...
    fn set_mx106_baud_rate(&mut self, id: u8, params: u8) -> Result<(), Error> {
        let params = u8_to_bytes(params);
    ...
    fn set_mx106_return_delay_time(&mut self, id: u8, params: u8) -> Result<(), Error> {
        let params = u8_to_bytes(params);
    ...
    fn set_mx106_drive_mode(&mut self, id: u8, params: u8) -> Result<(), Error> {
        let params = u8_to_bytes(params);
    ...
    fn set_mx106_operating_mode(&mut self, id: u8, params: u8) -> Result<(), Error> {
        let params = u8_to_bytes(params);
    ...
    fn set_mx106_secondary_id(&mut self, id: u8, params: u8) -> Result<(), Error> {
        let params = u8_to_bytes(params);
    ...
    fn set_mx106_protocol_type(&mut self, id: u8, params: u8) -> Result<(), Error> {
        let params = u8_to_bytes(params);
    ...
    fn set_mx106_homing_offset(&mut self, id: u8, params: u32) -> Result<(), Error> {
    ...
    fn set_mx106_moving_threshold(&mut self, id: u8, params: u32) -> Result<(), Error> {
        let params = u32_to_bytes(params);
        self.send(
            id,
            Instruction::Write,
    ...
    fn set_mx106_temperature_limit(&mut self, id: u8, params: u8) -> Result<(), Error> {
        let params = u8_to_bytes(params);
    ...
    fn set_mx106_max_voltage_limit(&mut self, id: u8, params: u16) -> Result<(), Error> {
    ...
    fn set_mx106_min_voltage_limit(&mut self, id: u8, params: u16) -> Result<(), Error> {
        let params = u16_to_bytes(params);
    ...
    fn set_mx106_pwm_limit(&mut self, id: u8, params: u16) -> Result<(), Error> {
        let params = u16_to_bytes(params);
    ...
    fn set_mx106_current_limit(&mut self, id: u8, params: u16) -> Result<(), Error> {
        let params = u16_to_bytes(params);
        self.send(id, Instruction::Write, &[38, 0, params[0], params[1]]);
        rprintln!("set_current_limit → {:?}", self.recv()?);
        Ok(())
    }
    ...
    fn set_mx106_acceleration_limit(&mut self, id: u8, params: u32) -> Result<(), Error> {
        let params = u32_to_bytes(params);
        self.send(
            id,
            Instruction::Write,
    ...
    fn set_mx106_velocity_limit(&mut self, id: u8, params: u32) -> Result<(), Error> {
        let params = u32_to_bytes(params);
        self.send(
            id,
            Instruction::Write,
    ...
    fn set_mx106_max_position_limit(&mut self, id: u8, params: u32) -> Result<(), Error> {
        let params = u32_to_bytes(params);
        self.send(
            id,
            Instruction::Write,
    ...
    fn set_mx106_min_position_limit(&mut self, id: u8, params: u32) -> Result<(), Error> {
        let params = u32_to_bytes(params);
        self.send(
            id,
            Instruction::Write,
    ...
    fn set_mx106_shutdown(&mut self, id: u8, params: u8) -> Result<(), Error> {
        let params = u8_to_bytes(params);
    ...
    fn set_mx106_torque_enable(&mut self, id: u8, params: u8) -> Result<(), Error> {
        let params = u8_to_bytes(params);
    ...
    fn set_mx106_led(&mut self, id: u8, params: u8) -> Result<(), Error> {
        let params = u8_to_bytes(params);
    ...
    fn set_mx106_status_return_level(&mut self, id: u8, params: u8) -> Result<(), Error> {
        let params = u8_to_bytes(params);
    ...
    fn set_mx106_velocity_i_gain(&mut self, id: u8, params: u16) -> Result<(), Error> {
        let params = u16_to_bytes(params);
    ...
    fn set_mx106_velocity_p_gain(&mut self, id: u8, params: u16) -> Result<(), Error> {
        let params = u16_to_bytes(params);
    ...
    fn set_mx106_position_d_gain(&mut self, id: u8, params: u16) -> Result<(), Error> {
        let params = u16_to_bytes(params);
    ...
    fn set_mx106_position_i_gain(&mut self, id: u8, params: u16) -> Result<(), Error> {
        let params = u16_to_bytes(params);
    ...
    fn set_mx106_position_p_gain(&mut self, id: u8, params: u16) -> Result<(), Error> {
        let params = u16_to_bytes(params);
    ...
    fn set_mx106_feedforward_2nd_gain(&mut self, id: u8, params: u16) -> Result<(), Error> {
        let params = u16_to_bytes(params);
    ...
    fn set_mx106_feedforward_1st_gain(&mut self, id: u8, params: u16) -> Result<(), Error> {
        let params = u16_to_bytes(params);
    ...
    fn set_mx106_bus_watchdog(&mut self, id: u8, params: u8) -> Result<(), Error> {
        let params = u8_to_bytes(params);
    ...
    fn set_mx106_goal_pwm(&mut self, id: u8, params: u16) -> Result<(), Error> {
        let params = u16_to_bytes(params);
    ...
    fn set_mx106_goal_current(&mut self, id: u8, params: u16) -> Result<(), Error> {
        let params = u16_to_bytes(params);
        self.send(id, Instruction::Write, &[102, 0, params[0], params[1]]);
        rprintln!("set_goal_current → {:?}", self.recv()?);
        Ok(())
    }
    ...
    fn set_mx106_goal_velocity(&mut self, id: u8, params: u32) -> Result<(), Error> {
        let params = u32_to_bytes(params);
        self.send(
            id,
            Instruction::Write,
    ...
    fn set_mx106_profile_acceleration(&mut self, id: u8, params: u32) -> Result<(), Error> {
        let params = u32_to_bytes(params);
        self.send(
            id,
            Instruction::Write,
    ...
    fn set_mx106_profile_velocity(&mut self, id: u8, params: u32) -> Result<(), Error> {
        let params = u32_to_bytes(params);
        self.send(
            id,
            Instruction::Write,
    ...
    fn set_mx106_goal_position(&mut self, id: u8, params: u32) -> Result<(), Error> {
        let params = u32_to_bytes(params);
        self.send(
            id,
            Instruction::Write,
