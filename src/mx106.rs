...
pub trait MX106<Error>: Protocol<Error> {
    ...
    fn set_mx106_id(&mut self, id: u8, params: u8) {
        let params = u8_to_bytes(params);
        self.send(id, Instruction::Write, &[7, 0, params[0]]);
        rprintln!("set_id → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_baud_rate(&mut self, id: u8, params: u8) {
        let params = u8_to_bytes(params);
        self.send(id, Instruction::Write, &[8, 0, params[0]]);
        rprintln!("set_baud_rate → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_return_delay_time(&mut self, id: u8, params: u8) {
        let params = u8_to_bytes(params);
        self.send(id, Instruction::Write, &[9, 0, params[0]]);
        rprintln!("set_return_delay_time → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_drive_mode(&mut self, id: u8, params: u8) {
        let params = u8_to_bytes(params);
        self.send(id, Instruction::Write, &[10, 0, params[0]]);
        rprintln!("set_drive_mode → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_operating_mode(&mut self, id: u8, params: u8) {
        let params = u8_to_bytes(params);
        self.send(id, Instruction::Write, &[11, 0, params[0]]);
        rprintln!("set_operating_mode → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_secondary_id(&mut self, id: u8, params: u8) {
        let params = u8_to_bytes(params);
        self.send(id, Instruction::Write, &[12, 0, params[0]]);
        rprintln!("set_secondary_id → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_protocol_type(&mut self, id: u8, params: u8) {
        let params = u8_to_bytes(params);
        self.send(id, Instruction::Write, &[13, 0, params[0]]);
        rprintln!("set_protocol_type → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_homing_offset(&mut self, id: u8, params: u32) {
        ...
        rprintln!("set_homing_offset → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_moving_threshold(&mut self, id: u8, params: u32) {
        let params = u32_to_bytes(params);
        self.send(
            id,
            Instruction::Write,
        ...
        rprintln!("set_moving_threshold → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_temperature_limit(&mut self, id: u8, params: u8) {
        let params = u8_to_bytes(params);
        self.send(id, Instruction::Write, &[31, 0, params[0]]);
        rprintln!("set_temperature_limit → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_max_voltage_limit(&mut self, id: u8, params: u16) {
        let params = u16_to_bytes(params);
        self.send(id, Instruction::Write, &[32, 0, params[0], params[1]]);
        rprintln!("set_max_voltage_limit → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_min_voltage_limit(&mut self, id: u8, params: u16) {
        let params = u16_to_bytes(params);
        self.send(id, Instruction::Write, &[34, 0, params[0], params[1]]);
        rprintln!("set_min_voltage_limit → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_pwm_limit(&mut self, id: u8, params: u16) {
        let params = u16_to_bytes(params);
        self.send(id, Instruction::Write, &[36, 0, params[0], params[1]]);
        rprintln!("set_pwm_limit → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_current_limit(&mut self, id: u8, params: u16) {
        let params = u16_to_bytes(params);
        self.send(id, Instruction::Write, &[38, 0, params[0], params[1]]);
        rprintln!("set_current_limit → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_acceleration_limit(&mut self, id: u8, params: u32) {
        let params = u32_to_bytes(params);
        self.send(
            id,
            Instruction::Write,
        ...
        rprintln!("set_acceleration_limit → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_velocity_limit(&mut self, id: u8, params: u32) {
        let params = u32_to_bytes(params);
        self.send(
            id,
            Instruction::Write,
        ...
        rprintln!("set_velocity_limit → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_max_position_limit(&mut self, id: u8, params: u32) {
        let params = u32_to_bytes(params);
        self.send(
            id,
            Instruction::Write,
        ...
        rprintln!("set_max_position_limit → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_min_position_limit(&mut self, id: u8, params: u32) {
        let params = u32_to_bytes(params);
        self.send(
            id,
            Instruction::Write,
        ...
        rprintln!("set_min_position_limit → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_shutdown(&mut self, id: u8, params: u8) {
        let params = u8_to_bytes(params);
        self.send(id, Instruction::Write, &[63, 0, params[0]]);
        rprintln!("set_shutdown → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_torque_enable(&mut self, id: u8, params: u8) {
        let params = u8_to_bytes(params);
        self.send(id, Instruction::Write, &[64, 0, params[0]]);
        rprintln!("set_torque_enable → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_led(&mut self, id: u8, params: u8) {
        let params = u8_to_bytes(params);
        self.send(id, Instruction::Write, &[65, 0, params[0]]);
        rprintln!("set_led → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_status_return_level(&mut self, id: u8, params: u8) {
        let params = u8_to_bytes(params);
        self.send(id, Instruction::Write, &[68, 0, params[0]]);
        rprintln!("set_status_return_level → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_velocity_i_gain(&mut self, id: u8, params: u16) {
        let params = u16_to_bytes(params);
        self.send(id, Instruction::Write, &[76, 0, params[0], params[1]]);
        rprintln!("set_velocity_i_gain → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_velocity_p_gain(&mut self, id: u8, params: u16) {
        let params = u16_to_bytes(params);
        self.send(id, Instruction::Write, &[78, 0, params[0], params[1]]);
        rprintln!("set_velocity_p_gain → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_position_d_gain(&mut self, id: u8, params: u16) {
        let params = u16_to_bytes(params);
        self.send(id, Instruction::Write, &[80, 0, params[0], params[1]]);
        rprintln!("set_position_d_gain → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_position_i_gain(&mut self, id: u8, params: u16) {
        let params = u16_to_bytes(params);
        self.send(id, Instruction::Write, &[82, 0, params[0], params[1]]);
        rprintln!("set_position_i_gain → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_position_p_gain(&mut self, id: u8, params: u16) {
        let params = u16_to_bytes(params);
        self.send(id, Instruction::Write, &[84, 0, params[0], params[1]]);
        rprintln!("set_position_p_gain → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_feedforward_2nd_gain(&mut self, id: u8, params: u16) {
        let params = u16_to_bytes(params);
        self.send(id, Instruction::Write, &[88, 0, params[0], params[1]]);
        rprintln!("set_feedforward_2nd_gain → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_feedforward_1st_gain(&mut self, id: u8, params: u16) {
        let params = u16_to_bytes(params);
        self.send(id, Instruction::Write, &[90, 0, params[0], params[1]]);
        rprintln!("set_feedforward_1st_gain → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_bus_watchdog(&mut self, id: u8, params: u8) {
        let params = u8_to_bytes(params);
        self.send(id, Instruction::Write, &[98, 0, params[0]]);
        rprintln!("set_bus_watchdog → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_goal_pwm(&mut self, id: u8, params: u16) {
        let params = u16_to_bytes(params);
        self.send(id, Instruction::Write, &[100, 0, params[0], params[1]]);
        rprintln!("set_goal_pwm → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_goal_current(&mut self, id: u8, params: u16) {
        let params = u16_to_bytes(params);
        self.send(id, Instruction::Write, &[102, 0, params[0], params[1]]);
        rprintln!("set_goal_current → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_goal_velocity(&mut self, id: u8, params: u32) {
        let params = u32_to_bytes(params);
        self.send(
            id,
            Instruction::Write,
        ...
        rprintln!("set_goal_velocity → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_profile_acceleration(&mut self, id: u8, params: u32) {
        let params = u32_to_bytes(params);
        self.send(
            id,
            Instruction::Write,
        ...
        rprintln!("set_profile_acceleration → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_profile_velocity(&mut self, id: u8, params: u32) {
        let params = u32_to_bytes(params);
        self.send(
            id,
            Instruction::Write,
        ...
        rprintln!("set_profile_velocity → {:?}", self.recv().ok().unwrap());
    }
    ...
    fn set_mx106_goal_position(&mut self, id: u8, params: u32) {
        let params = u32_to_bytes(params);
        self.send(
            id,
            Instruction::Write,
        ...
        rprintln!("set_goal_position → {:?}", self.recv().ok().unwrap());
    }
